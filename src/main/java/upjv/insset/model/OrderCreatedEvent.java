...
public class OrderCreatedEvent {
    ...
    public PlayerRank playerRank;      // Rang actuel du joueur dans Tuuuur
    public String itemId;              // ex: "tshirt-diamant"
    public String itemName;            // ex: "T-Shirt Rang Diamant"
    public PlayerRank requiredRank;    // Rang minimum requis pour acheter cet article
    public int quantity;
    ...
    public static OrderCreatedEvent of(String playerId, String playerName,
                                       ...
                                       String itemName, PlayerRank requiredRank,
